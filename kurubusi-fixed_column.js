(function () {
	...
	var fixedColumn = function (obj) {  //本体
	...
	fixedColumn.prototype.justiObj = function () {  //ページ下部追従
		var scroll_top = document.documentElement.scrollTop || document.body.scrollTop, //スクロール量
				client_height = document.documentElement.clientHeight || document.body.clientHeight, //画面の高さ
				scroll_bottom = client_height + scroll_top;
				rect_obj = this.obj.getBoundingClientRect(),
				obj_top = scroll_top + rect_obj.top, //objまでの高さ
